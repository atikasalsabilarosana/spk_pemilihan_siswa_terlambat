    ...
    <div class="container p-5">
        <form  action="insertskala.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id_skala">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Value</label>
                <input type="text" class="form-control" id="exampleInputPassword1" name="value">
            </div>
            <div class="mb-3">
