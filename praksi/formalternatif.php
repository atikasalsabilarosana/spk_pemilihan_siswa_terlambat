    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#"><span>Data</span> <i class="bi bi-chevron-down"></i></a>
          ...
          <li class="dropdown"><a href="#"><span>Form</span> <i class="bi bi-chevron-down active"></i></a>
            <ul>
    ...
    <div class="container p-5">
        <form  action="insertalternatif.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id_alternatif">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Nama Alternatif</label>
                <input type="text" class="form-control" id="exampleInputPassword1" name="nm_alternatif">
            </div>
            <div class="float-end">
