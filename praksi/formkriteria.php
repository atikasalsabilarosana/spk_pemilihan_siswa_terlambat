  ...
  <div class="container p-5">
        <form  action="insertkriteria.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id_kriteria">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Nama Kriteria</label>
                <input type="text" class="form-control" id="exampleInputPassword1" name="nm_kriteria">
            </div>
            <div class="float-end">
